...
{{ include "prom-stack.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "prom-stack.selectorLabels" -}}
...
*/}}
{{- define "prom-stack.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "prom-stack.fullname" .) .Values.serviceAccount.name }}
{{- else }}
